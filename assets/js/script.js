...
const tasksThead = document.getElementById("tasks-thead");
const todayDate = document.getElementById("today-date");
const taskArray = [
    { id: 1, taskName: "Tarea 01", taskDone: false },
    { id: 2, taskName: "Tarea 02", taskDone: false },
    { id: 3, taskName: "Tarea 03", taskDone: false },
];
let doneArray = [];
...
const getHtmlTaskList = () => {
    ...
    taskArray.forEach((task) => {
        ...
        <div class="task-box" id="${task.id}">
            ...
            <div class="task-name">${task.taskName}${
                task.taskDone
...
tasksThead.addEventListener("click", (e) => {
    ...
    if (e.target && e.target.id === "task-sort-btn") {
